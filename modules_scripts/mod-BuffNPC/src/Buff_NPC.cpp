...
{
public:
    BuffNPC() : CreatureScript("npc_buff") {}
    
bool OnGossipHello(Player* pPlayer, Creature* pCreature)
{
    if(sWorld.GetModuleBoolConfig("Npc_Buff.OnlyGMs", false)) // If Npc_Buff.OnlyGMs is enabled in worldserver.conf
    ...
    bool EnableSmallBuff = sWorld.GetModuleBoolConfig("Npc_Buff.EnableSmallBuff", true);
    bool EnableGreatBuff = sWorld.GetModuleBoolConfig("Npc_Buff.EnableGreatBuff", true);
    bool EnableGMBuff = sWorld.GetModuleBoolConfig("Npc_Buff.EnableGMBuff", true);
    bool GMBuffAll = sWorld.GetModuleBoolConfig("Npc_Buff.GMBuffAll", true);
    bool EnablePlayerTools = sWorld.GetModuleBoolConfig("Npc_Buff.EnablePlayerTools", true);
    bool EnableResSickness = sWorld.GetModuleBoolConfig("Npc_Buff.EnableRemoveResSickness", true);
    bool EnableGivemeGold = sWorld.GetModuleBoolConfig("Npc_Buff.EnableGivemeGold", false);
...
class BuffNPC_Announce : public PlayerScript
{
public:

    BuffNPC_Announce() : PlayerScript("BuffNPC_Announce") {}
